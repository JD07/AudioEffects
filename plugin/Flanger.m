...
classdef Flanger < handle
    ...
    methods(Access = public)
        ...
        function setParameters(obj, parameters_)
            ...
            adParams.wetLevel_dB = -3.0;
            adParams.dryLevel_dB = -3.0;
        ...
        function outputFrame = processAudioFrame(obj, inputFrame, inputChannels, outputChannels)
            ...
            params.leftDelay_mSec = depth * modDepth_mSec + minDelay_mSec;
            
            depth = 0.5 * lfoOutput.quadPhaseOutput_pos + 0.5; % 将LFO双极性输出转为单极性
            params.rightDelay_mSec = depth * modDepth_mSec + minDelay_mSec;
            % 右声道延迟匹配左声道
